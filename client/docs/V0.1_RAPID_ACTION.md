...
0. Dialog + staged flow for primary actions (Generate) — 1A → 1B → 1C

- Summary: Roll out the Generate flow in three small, verifiable stages so we validate wiring and avoid unnecessary model calls. Each stage must be tested/verified before enabling the next.
